...
const Blogs: React.FC = () => {
    ...
    return (
        <div>
            <Header />
            <div className="blog-container" style={{marginLeft: "6%"}}>
                ...
                <div className="blog-image">
                    <img src="src/assets/hinh10.jpg" alt="God is dead - Nietzsche" style={{width: "95%"}}/>
                </div>
            </div>
            ...
            <div className="container5" style={{ marginLeft: "9%",}}>

                <div className="hero-container3" style={{marginLeft: "20%"}}>
                    <h1 className="hero-title">Khám phá triết lý</h1>
                    <p className="hero-description" style={{marginBottom: 50}}>
